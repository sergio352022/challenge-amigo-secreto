...
<body>
    ...
    <p>Projeto utilizado no curso de lógica de programação da Alura/Oracle Next Education: <br> Iniciante em Programação G8 - ONE. Ano 2025.</p>
    .</p>
  ## 🚀 Tecnologias
...
<br>Os nomes inseridos serão exibidos em uma lista visível na página, e ao finalizar, um botão "Sortear Amigo" <br>selecionará um dos nomes de forma aleatória, exibindo o resultado na tela.
